...
const Table = ({ initialCurrencies=[], initialSortValue='invert', initialSort=0, BASE_API }: TableProps) => {
  const [ currencies, setCurrencies ] = useState<currency[]>(initialCurrencies);
  const [ sortValue, setSortValue ] = useState<sort>(initialSortValue);
  const [ sort, setSort ] = useState<number>(initialSort);
